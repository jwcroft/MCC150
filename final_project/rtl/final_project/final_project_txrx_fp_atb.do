...
if {! [file exists $base_dir/final_project_txrx_fp]} {
    file delete -force $base_dir/final_project_txrx_fp
}

project new $base_dir final_project_txrx_fp
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/final_project/final_project_txrx_fp_fpc.do"
} else {
...
vcom -quiet $base_dir/final_project/final_project_txrx_fp_safe_path_msim.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_8_PSK_Mapper.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_ChanView.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_ChanView1.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_ChanView2.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_ChanView3.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_ChanView4.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_Decode_symbols_into_bitstream.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_InterpolatingFIR.vhd
...
vcom -quiet $base_dir/final_project/final_project_txrx_fp_Scale2_Q.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_Scale3_I.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_Scale3_I1.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_Scale3_I2.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_Scale3_I3.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_Scale3_I4.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_Scale3_I5.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_Scale3_I6.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_SingleRateFIR.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_SingleRateFIR1.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_SingleRateFIR2.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_SingleRateFIR_I.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_SingleRateFIR_Q.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_Symbol_recovery.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_Symbol_sample_adaptation.vhd
vcom -quiet -O0 $base_dir/final_project/final_project_txrx_fp_atb.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_rx_bits} mismatch] == 0 && $mismatch } {
                report_mismatch rx_bits $cyclenum
            }
            if { [catch {exa mismatch_mem_read_bits} mismatch] == 0 && $mismatch } {
                report_mismatch mem_read_bits $cyclenum
            }
            if { [catch {exa mismatch_sym_phase} mismatch] == 0 && $mismatch } {
                report_mismatch sym_phase $cyclenum
            }
            if { [catch {exa mismatch_left_power} mismatch] == 0 && $mismatch } {
                report_mismatch left_power $cyclenum
            }
            if { [catch {exa mismatch_main_power} mismatch] == 0 && $mismatch } {
                report_mismatch main_power $cyclenum
            }
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps final_project_txrx_fp_atb 
    do $base_dir/final_project/final_project_txrx_fp_atb.wav.do
