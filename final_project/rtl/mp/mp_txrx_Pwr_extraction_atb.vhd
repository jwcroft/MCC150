...
entity mp_txrx_Pwr_extraction_atb is
end;

architecture normal of mp_txrx_Pwr_extraction_atb is
...
component mp_txrx_Pwr_extraction_stm is
    port (
...
dut : mp_txrx_Pwr_extraction port map (
    in_4_dv_stm,
    in_3_dc_stm,
    in_1_In1_stm,
    in_2_In2_stm,
...
sim : mp_txrx_Pwr_extraction_stm port map (
    in_4_dv_stm,
    in_3_dc_stm,
    in_1_In1_stm,
    in_2_In2_stm,
