...
entity mp_txrx_Scale1_atb is
end;

architecture normal of mp_txrx_Scale1_atb is
...
component mp_txrx_Scale1_stm is
    port (
...
sim : mp_txrx_Scale1_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
