...
entity mp_txrx_Scale3_I_atb is
end;

architecture normal of mp_txrx_Scale3_I_atb is
...
component mp_txrx_Scale3_I_stm is
    port (
...
sim : mp_txrx_Scale3_I_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
