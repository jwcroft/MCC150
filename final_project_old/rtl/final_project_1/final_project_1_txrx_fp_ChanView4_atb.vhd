...
-- VHDL created from final_project_1_txrx_fp_ChanView4
...
entity final_project_1_txrx_fp_ChanView4_atb is
end;

architecture normal of final_project_1_txrx_fp_ChanView4_atb is
...
component final_project_1_txrx_fp_ChanView4 is
    port (
        ...
        c0_o : out std_logic_vector(27 downto 0);  -- sfix28
        clk : in std_logic;
        areset : in std_logic
    );
end component;

component final_project_1_txrx_fp_ChanView4_stm is
    port (
        xIn_v_stm : out std_logic_vector(0 downto 0);
        xIn_c_stm : out std_logic_vector(7 downto 0);
        xIn_0_stm : out std_logic_vector(27 downto 0);
        c0_o_stm : out std_logic_vector(27 downto 0);
        clk : out std_logic;
...
signal xIn_0_stm : STD_LOGIC_VECTOR (27 downto 0);
signal c0_o_stm : STD_LOGIC_VECTOR (27 downto 0);
signal xIn_v_dut : STD_LOGIC_VECTOR (0 downto 0);
signal xIn_c_dut : STD_LOGIC_VECTOR (7 downto 0);
signal xIn_0_dut : STD_LOGIC_VECTOR (27 downto 0);
signal c0_o_dut : STD_LOGIC_VECTOR (27 downto 0);
...
dut : final_project_1_txrx_fp_ChanView4 port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    c0_o_dut,
...
sim : final_project_1_txrx_fp_ChanView4_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    c0_o_stm,
