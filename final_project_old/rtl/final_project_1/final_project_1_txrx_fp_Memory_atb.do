...
if {! [file exists $base_dir/final_project_1_txrx_fp_Memory]} {
    file delete -force $base_dir/final_project_1_txrx_fp_Memory
}

project new $base_dir final_project_1_txrx_fp_Memory
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/final_project_1/final_project_1_txrx_fp_Memory_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/final_project_1/final_project_1_txrx_fp_Memory_atb.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Memory_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_2_qv} mismatch] == 0 && $mismatch } {
                report_mismatch out_2_qv $cyclenum
            }
            if { [catch {exa mismatch_out_3_qc} mismatch] == 0 && $mismatch } {
                report_mismatch out_3_qc $cyclenum
            }
            if { [catch {exa mismatch_out_1_mem_tx} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_mem_tx $cyclenum
            }
            if { [catch {exa mismatch_out_5_qv1} mismatch] == 0 && $mismatch } {
                report_mismatch out_5_qv1 $cyclenum
            }
            if { [catch {exa mismatch_out_6_qc1} mismatch] == 0 && $mismatch } {
                report_mismatch out_6_qc1 $cyclenum
            }
            if { [catch {exa mismatch_out_4_mem_rx} mismatch] == 0 && $mismatch } {
                report_mismatch out_4_mem_rx $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps final_project_1_txrx_fp_Memory_atb 
    do $base_dir/final_project_1/final_project_1_txrx_fp_Memory_atb.wav.do
