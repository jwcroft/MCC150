...
entity final_project_1_txrx_fp_Memory_atb is
end;

architecture normal of final_project_1_txrx_fp_Memory_atb is
...
component final_project_1_txrx_fp_Memory_stm is
    port (
...
dut : final_project_1_txrx_fp_Memory port map (
    in_1_dv_stm,
    in_2_dc_stm,
    in_3_trigger_rx_stm,
    in_4_dc1_stm,
...
sim : final_project_1_txrx_fp_Memory_stm port map (
    in_1_dv_stm,
    in_2_dc_stm,
    in_3_trigger_rx_stm,
    in_4_dc1_stm,
