...
entity final_project_1_txrx_fp_Scale2_Q_atb is
end;

architecture normal of final_project_1_txrx_fp_Scale2_Q_atb is
...
component final_project_1_txrx_fp_Scale2_Q_stm is
    port (
...
dut : final_project_1_txrx_fp_Scale2_Q port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
...
sim : final_project_1_txrx_fp_Scale2_Q_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
