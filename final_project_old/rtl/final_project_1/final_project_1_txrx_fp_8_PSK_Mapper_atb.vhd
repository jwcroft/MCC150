...
entity final_project_1_txrx_fp_8_PSK_Mapper_atb is
end;

architecture normal of final_project_1_txrx_fp_8_PSK_Mapper_atb is
...
component final_project_1_txrx_fp_8_PSK_Mapper_stm is
    port (
...
dut : final_project_1_txrx_fp_8_PSK_Mapper port map (
    in_2_dv_stm,
    in_3_dc_stm,
    in_1_bit_stream_stm,
    out_3_qv_dut,
...
sim : final_project_1_txrx_fp_8_PSK_Mapper_stm port map (
    in_2_dv_stm,
    in_3_dc_stm,
    in_1_bit_stream_stm,
    out_3_qv_stm,
