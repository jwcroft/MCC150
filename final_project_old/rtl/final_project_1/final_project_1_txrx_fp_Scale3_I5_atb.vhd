...
entity final_project_1_txrx_fp_Scale3_I5_atb is
end;

architecture normal of final_project_1_txrx_fp_Scale3_I5_atb is
...
component final_project_1_txrx_fp_Scale3_I5_stm is
    port (
        ...
        qOut_0_stm : out std_logic_vector(17 downto 0);
...
signal qOut_0_stm : STD_LOGIC_VECTOR (17 downto 0);
...
signal qOut_0_dut : STD_LOGIC_VECTOR (17 downto 0);
...
checkxIn : process (clk, areset, xIn_0_dut, xIn_0_stm, gain_i_dut, gain_i_stm)
begin
END PROCESS;


-- Channelized data out check
checkqOut : process (clk, areset, qOut_0_dut, qOut_0_stm, eOut_0_dut, eOut_0_stm)
...
dut : final_project_1_txrx_fp_Scale3_I5 port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
...
sim : final_project_1_txrx_fp_Scale3_I5_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
