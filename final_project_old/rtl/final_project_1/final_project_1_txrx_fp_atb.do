...
if {$argc > 0} {
    ...
    quietly set base_dir "C:/git_projects/MCC150/final_project/./rtl"
...
if {! [file exists $base_dir/final_project_1_txrx_fp]} {
    file delete -force $base_dir/final_project_1_txrx_fp
}

project new $base_dir final_project_1_txrx_fp
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/final_project_1/final_project_1_txrx_fp_fpc.do"
} else {
...
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_8_PSK_Mapper.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_ChanView.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_ChanView1.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_ChanView2.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_ChanView3.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_ChanView4.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_InterpolatingFIR.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_InterpolatingFIR1.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Memory.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Power_extraction.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Scale.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Scale1.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Scale2_Q.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Scale3_I.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Scale3_I1.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Scale3_I2.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Scale3_I3.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Scale3_I4.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Scale3_I5.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Scale3_I6.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_SingleRateFIR.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_SingleRateFIR1.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_SingleRateFIR2.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_SingleRateFIR_I.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_SingleRateFIR_Q.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Symbol_recovery.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Symbol_sample_adaptation.vhd
vcom -quiet -O0 $base_dir/final_project_1/final_project_1_txrx_fp_atb.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_DAC_I} mismatch] == 0 && $mismatch } {
                report_mismatch DAC_I $cyclenum
            }
            if { [catch {exa mismatch_DAC_Q} mismatch] == 0 && $mismatch } {
                report_mismatch DAC_Q $cyclenum
            }
            ...
            if { [catch {exa mismatch_ma_0} mismatch] == 0 && $mismatch } {
                report_mismatch ma_0 $cyclenum
            }
            if { [catch {exa mismatch_ma_1} mismatch] == 0 && $mismatch } {
                report_mismatch ma_1 $cyclenum
            }
            if { [catch {exa mismatch_ma_2} mismatch] == 0 && $mismatch } {
                report_mismatch ma_2 $cyclenum
            }
            if { [catch {exa mismatch_ma_3} mismatch] == 0 && $mismatch } {
                report_mismatch ma_3 $cyclenum
            }
            if { [catch {exa mismatch_ma_4} mismatch] == 0 && $mismatch } {
                report_mismatch ma_4 $cyclenum
            }
            if { [catch {exa mismatch_ma_5} mismatch] == 0 && $mismatch } {
                report_mismatch ma_5 $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps final_project_1_txrx_fp_atb 
    do $base_dir/final_project_1/final_project_1_txrx_fp_atb.wav.do
