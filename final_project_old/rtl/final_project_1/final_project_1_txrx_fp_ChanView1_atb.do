...
if {! [file exists $base_dir/final_project_1_txrx_fp_ChanView1]} {
    file delete -force $base_dir/final_project_1_txrx_fp_ChanView1
}

project new $base_dir final_project_1_txrx_fp_ChanView1
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/final_project_1/final_project_1_txrx_fp_ChanView1_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/final_project_1/final_project_1_txrx_fp_ChanView1_atb.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_ChanView1_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_c0_o} mismatch] == 0 && $mismatch } {
                report_mismatch c0_o $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps final_project_1_txrx_fp_ChanView1_atb 
    do $base_dir/final_project_1/final_project_1_txrx_fp_ChanView1_atb.wav.do
