...
if {! [file exists $base_dir/final_project_1_txrx_fp_Scale3_I]} {
    file delete -force $base_dir/final_project_1_txrx_fp_Scale3_I
}

project new $base_dir final_project_1_txrx_fp_Scale3_I
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/final_project_1/final_project_1_txrx_fp_Scale3_I_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/final_project_1/final_project_1_txrx_fp_Scale3_I_atb.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Scale3_I_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps final_project_1_txrx_fp_Scale3_I_atb 
    do $base_dir/final_project_1/final_project_1_txrx_fp_Scale3_I_atb.wav.do
