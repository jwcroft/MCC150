...
entity final_project_1_txrx_fp_SingleRateFIR_atb is
end;

architecture normal of final_project_1_txrx_fp_SingleRateFIR_atb is
...
component final_project_1_txrx_fp_SingleRateFIR_stm is
    port (
...
dut : final_project_1_txrx_fp_SingleRateFIR port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xOut_v_dut,
...
sim : final_project_1_txrx_fp_SingleRateFIR_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xOut_v_stm,
