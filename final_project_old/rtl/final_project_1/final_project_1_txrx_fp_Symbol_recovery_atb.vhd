...
entity final_project_1_txrx_fp_Symbol_recovery_atb is
end;

architecture normal of final_project_1_txrx_fp_Symbol_recovery_atb is
...
component final_project_1_txrx_fp_Symbol_recovery_stm is
    port (
...
dut : final_project_1_txrx_fp_Symbol_recovery port map (
    in_3_v_stm,
    in_5_c_stm,
    in_1_in_I_stm,
    in_2_in_Q_stm,
...
sim : final_project_1_txrx_fp_Symbol_recovery_stm port map (
    in_3_v_stm,
    in_5_c_stm,
    in_1_in_I_stm,
    in_2_in_Q_stm,
