...
if {! [file exists $base_dir/final_project_1_txrx_fp_Symbol_recovery]} {
    file delete -force $base_dir/final_project_1_txrx_fp_Symbol_recovery
}

project new $base_dir final_project_1_txrx_fp_Symbol_recovery
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/final_project_1/final_project_1_txrx_fp_Symbol_recovery_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/final_project_1/final_project_1_txrx_fp_Symbol_recovery_atb.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Symbol_recovery_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_3_qv} mismatch] == 0 && $mismatch } {
                report_mismatch out_3_qv $cyclenum
            }
            if { [catch {exa mismatch_out_8_qc} mismatch] == 0 && $mismatch } {
                report_mismatch out_8_qc $cyclenum
            }
            if { [catch {exa mismatch_out_1_left_I} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_left_I $cyclenum
            }
            if { [catch {exa mismatch_out_2_left_Q} mismatch] == 0 && $mismatch } {
                report_mismatch out_2_left_Q $cyclenum
            }
            if { [catch {exa mismatch_out_4_main_I} mismatch] == 0 && $mismatch } {
                report_mismatch out_4_main_I $cyclenum
            }
            if { [catch {exa mismatch_out_5_main_Q} mismatch] == 0 && $mismatch } {
                report_mismatch out_5_main_Q $cyclenum
            }
            if { [catch {exa mismatch_out_6_right_I} mismatch] == 0 && $mismatch } {
                report_mismatch out_6_right_I $cyclenum
            }
            if { [catch {exa mismatch_out_7_right_Q} mismatch] == 0 && $mismatch } {
                report_mismatch out_7_right_Q $cyclenum
            }
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps final_project_1_txrx_fp_Symbol_recovery_atb 
    do $base_dir/final_project_1/final_project_1_txrx_fp_Symbol_recovery_atb.wav.do
