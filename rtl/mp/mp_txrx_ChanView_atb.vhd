...
-- VHDL created from mp_txrx_ChanView
...
entity mp_txrx_ChanView_atb is
end;

architecture normal of mp_txrx_ChanView_atb is
...
component mp_txrx_ChanView_stm is
    port (
...
sim : mp_txrx_ChanView_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    c0_o_stm,
