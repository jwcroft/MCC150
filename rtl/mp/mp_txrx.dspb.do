# This is the Run ModelSim file list for 'mp_txrx'

vcom -93 -quiet $base_dir/mp/mp_txrx.vhd
vcom -93 -quiet $base_dir/mp/mp_txrx.vhd
vcom -93 -quiet $base_dir/mp/mp_txrx.vhd
vcom -93 -quiet $base_dir/mp/mp_txrx.vhd
source $base_dir/mp/mp_txrx_BER_Extraction.dspb.do
source $base_dir/mp/mp_txrx_ChanView.dspb.do
source $base_dir/mp/mp_txrx_ChanView1.dspb.do
source $base_dir/mp/mp_txrx_ChanView2.dspb.do
source $base_dir/mp/mp_txrx_ChanView3.dspb.do
source $base_dir/mp/mp_txrx_ChanView4.dspb.do
source $base_dir/mp/mp_txrx_ChanView5.dspb.do
