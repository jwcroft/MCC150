# This is the top level tcl file for 'mp_txrx'
...
if {!$overwrite_opt && [project_exists mp_txrx]} {
    puts "The mp_txrx quartus project already exists."
    puts "Use 'overwrite option' to force project to be over-written/"
} elseif {![file exists "C:/git_projects/MCC150/./rtl/mp/mp_txrx.tcl"]}    {
    puts "You must run mp_txrx.tcl "
...
puts "Creating mp_txrx Quartus project..."

if $overwrite_opt {
    project_new -overwrite mp_txrx
} else {
    project_new mp_txrx
}

set_global_assignment -name FAMILY "Cyclone V"
set_global_assignment -name TOP_LEVEL_ENTITY mp_txrx
set_global_assignment -name DEVICE 5CSXFC6D6F31C6
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE C:/git_projects/MCC150/./rtl/mp/mp_txrx.sdc
source C:/git_projects/MCC150/./rtl/mp/mp_txrx.add.tcl

set_instance_assignment -name VIRTUAL_PIN ON -to fromADC_I
set_instance_assignment -name VIRTUAL_PIN ON -to fromADC_Q
set_instance_assignment -name VIRTUAL_PIN ON -to toDAC_I
set_instance_assignment -name VIRTUAL_PIN ON -to toDAC_Q
set_instance_assignment -name VIRTUAL_PIN ON -to sym_phase
set_instance_assignment -name VIRTUAL_PIN ON -to BER
set_instance_assignment -name VIRTUAL_PIN ON -to bit_error
set_instance_assignment -name VIRTUAL_PIN ON -to sym_pwr
...
source "C:/git_projects/MCC150/./rtl/mp/mp_txrx_fpc.add.tcl"
