...
entity mp_txrx_InterpolatingFIR_atb is
end;

architecture normal of mp_txrx_InterpolatingFIR_atb is
...
component mp_txrx_InterpolatingFIR_stm is
    port (
...
dut : mp_txrx_InterpolatingFIR port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xOut_v_dut,
...
sim : mp_txrx_InterpolatingFIR_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xOut_v_stm,
