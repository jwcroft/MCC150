...
entity mp_txrx_ChanView2_atb is
end;

architecture normal of mp_txrx_ChanView2_atb is
...
component mp_txrx_ChanView2_stm is
    port (
...
dut : mp_txrx_ChanView2 port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    c0_o_dut,
...
sim : mp_txrx_ChanView2_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    c0_o_stm,
