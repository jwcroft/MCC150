...
entity mp_txrx_SingleRateFIR1_Q_atb is
end;

architecture normal of mp_txrx_SingleRateFIR1_Q_atb is
...
component mp_txrx_SingleRateFIR1_Q_stm is
    port (
...
dut : mp_txrx_SingleRateFIR1_Q port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    busIn_writedata_stm,
...
sim : mp_txrx_SingleRateFIR1_Q_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    busIn_writedata_stm,
