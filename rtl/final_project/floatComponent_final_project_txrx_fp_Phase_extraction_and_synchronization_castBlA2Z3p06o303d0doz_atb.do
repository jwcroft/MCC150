...
if {! [file exists $base_dir/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_castBlA2Zcp06of03p06o303d0doz]} {
    file delete -force $base_dir/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_castBlA2Zcp06of03p06o303d0doz
}

project new $base_dir floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_castBlA2Zcp06of03p06o303d0doz
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/final_project/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_castBlA2Z3p06o303d0doz_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/final_project/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_castBlA2Zp06o303d0doz_atb.vhd
vcom -quiet $base_dir/final_project/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_castBlA2Zp06o303d0doz_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_castBlA2Zcp06of03p06o303d0doz_atb 
    do $base_dir/final_project/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_castBlA2Zo303d0doz_atb.wav.do
