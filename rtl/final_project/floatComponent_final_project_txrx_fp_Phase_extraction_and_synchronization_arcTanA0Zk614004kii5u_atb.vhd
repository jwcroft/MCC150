...
entity floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_arcTanA0Z0m6140i0k614004kii5u_atb is
end;

architecture normal of floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_arcTanA0Z0m6140i0k614004kii5u_atb is
...
component floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_arcTanA0Z0m6140i0k614004kii5u_stm is
    port (
...
dut : floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_arcTanA0Z0m6140i0k614004kii5u port map (
    in_0_stm,
    in_1_stm,
    out_primWireOut_dut,
        clk,
...
sim : floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_arcTanA0Z0m6140i0k614004kii5u_stm port map (
    in_0_stm,
    in_1_stm,
    out_primWireOut_stm,
        clk,
