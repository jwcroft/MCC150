...
if {! [file exists $base_dir/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_modBloA0Z03p06o303d06o00rf30z]} {
    file delete -force $base_dir/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_modBloA0Z03p06o303d06o00rf30z
}

project new $base_dir floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_modBloA0Z03p06o303d06o00rf30z
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/final_project/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_modBloA0Z03d06o00rf30z_fpc.do"
} else {
...
vcom -quiet $base_dir/final_project/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_modBloA0Z6o303d06o00rf30z.vhd
vcom -quiet -O0 $base_dir/final_project/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_modBloA0Z3d06o00rf30z_atb.vhd
vcom -quiet $base_dir/final_project/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_modBloA0Z3d06o00rf30z_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_modBloA0Z03p06o303d06o00rf30z_atb 
    do $base_dir/final_project/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_modBloA0Z6o00rf30z_atb.wav.do
