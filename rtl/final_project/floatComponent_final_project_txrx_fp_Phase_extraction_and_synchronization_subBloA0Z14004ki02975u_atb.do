...
if {! [file exists $base_dir/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_subBloA0Z140i0k614004ki02975u]} {
    file delete -force $base_dir/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_subBloA0Z140i0k614004ki02975u
}

project new $base_dir floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_subBloA0Z140i0k614004ki02975u
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/final_project/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_subBloA0Z14004ki02975u_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/final_project/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_subBloA0Z4004ki02975u_atb.vhd
vcom -quiet $base_dir/final_project/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_subBloA0Z4004ki02975u_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_subBloA0Z140i0k614004ki02975u_atb 
    do $base_dir/final_project/floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_subBloA0Z4ki02975u_atb.wav.do
