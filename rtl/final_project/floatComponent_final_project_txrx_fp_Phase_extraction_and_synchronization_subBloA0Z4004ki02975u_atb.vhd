...
entity floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_subBloA0Z140i0k614004ki02975u_atb is
end;

architecture normal of floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_subBloA0Z140i0k614004ki02975u_atb is
...
component floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_subBloA0Z140i0k614004ki02975u_stm is
    port (
...
dut : floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_subBloA0Z140i0k614004ki02975u port map (
    in_0_stm,
    in_1_stm,
    out_primWireOut_dut,
        clk,
...
sim : floatComponent_final_project_txrx_fp_Phase_extraction_and_synchronization_subBloA0Z140i0k614004ki02975u_stm port map (
    in_0_stm,
    in_1_stm,
    out_primWireOut_stm,
        clk,
