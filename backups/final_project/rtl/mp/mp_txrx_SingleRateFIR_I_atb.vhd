...
entity mp_txrx_SingleRateFIR_I_atb is
end;

architecture normal of mp_txrx_SingleRateFIR_I_atb is
...
component mp_txrx_SingleRateFIR_I_stm is
    port (
...
dut : mp_txrx_SingleRateFIR_I port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    busIn_writedata_stm,
...
sim : mp_txrx_SingleRateFIR_I_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    busIn_writedata_stm,
