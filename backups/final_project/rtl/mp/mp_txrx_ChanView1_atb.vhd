...
-- VHDL created from mp_txrx_ChanView1
...
entity mp_txrx_ChanView1_atb is
end;

architecture normal of mp_txrx_ChanView1_atb is
...
component mp_txrx_ChanView1 is
    port (
        ...
        c0_o : out std_logic_vector(29 downto 0);  -- sfix30
        clk : in std_logic;
        areset : in std_logic
    );
end component;

component mp_txrx_ChanView1_stm is
    port (
...
signal c0_o_stm : STD_LOGIC_VECTOR (29 downto 0);
...
signal c0_o_dut : STD_LOGIC_VECTOR (29 downto 0);
...
dut : mp_txrx_ChanView1 port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    c0_o_dut,
...
sim : mp_txrx_ChanView1_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    c0_o_stm,
