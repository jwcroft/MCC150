...
-- VHDL created from final_project_txrx_fp_ChanView2
...
entity final_project_txrx_fp_ChanView2_atb is
end;

architecture normal of final_project_txrx_fp_ChanView2_atb is
...
component final_project_txrx_fp_ChanView2_stm is
    port (
...
dut : final_project_txrx_fp_ChanView2 port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    c0_o_dut,
...
sim : final_project_txrx_fp_ChanView2_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    c0_o_stm,
