...
-- VHDL created from final_project_txrx_fp_Scale3_I1
...
entity final_project_txrx_fp_Scale3_I1_atb is
end;

architecture normal of final_project_txrx_fp_Scale3_I1_atb is
...
component final_project_txrx_fp_Scale3_I1_stm is
    port (
...
dut : final_project_txrx_fp_Scale3_I1 port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
...
sim : final_project_txrx_fp_Scale3_I1_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
