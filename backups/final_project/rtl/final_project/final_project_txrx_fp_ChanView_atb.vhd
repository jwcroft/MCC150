...
entity final_project_txrx_fp_ChanView_atb is
end;

architecture normal of final_project_txrx_fp_ChanView_atb is
...
component final_project_txrx_fp_ChanView_stm is
    port (
...
dut : final_project_txrx_fp_ChanView port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    c0_o_dut,
...
sim : final_project_txrx_fp_ChanView_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    c0_o_stm,
