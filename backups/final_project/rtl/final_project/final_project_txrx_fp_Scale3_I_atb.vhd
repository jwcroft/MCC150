...
entity final_project_txrx_fp_Scale3_I_atb is
end;

architecture normal of final_project_txrx_fp_Scale3_I_atb is
...
component final_project_txrx_fp_Scale3_I_stm is
    port (
...
dut : final_project_txrx_fp_Scale3_I port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
...
sim : final_project_txrx_fp_Scale3_I_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
