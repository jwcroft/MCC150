...
entity final_project_txrx_fp_InterpolatingFIR1_atb is
end;

architecture normal of final_project_txrx_fp_InterpolatingFIR1_atb is
...
component final_project_txrx_fp_InterpolatingFIR1_stm is
    port (
...
dut : final_project_txrx_fp_InterpolatingFIR1 port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xOut_v_dut,
...
sim : final_project_txrx_fp_InterpolatingFIR1_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xOut_v_stm,
