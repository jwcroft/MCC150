...
-- VHDL created from final_project_txrx_fp_ChanView3
...
entity final_project_txrx_fp_ChanView3_atb is
end;

architecture normal of final_project_txrx_fp_ChanView3_atb is
...
component final_project_txrx_fp_ChanView3_stm is
    port (
...
dut : final_project_txrx_fp_ChanView3 port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    c0_o_dut,
...
sim : final_project_txrx_fp_ChanView3_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    c0_o_stm,
