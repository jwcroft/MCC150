...
-- VHDL created from final_project_txrx_fp_Scale3_I2
...
entity final_project_txrx_fp_Scale3_I2_atb is
end;

architecture normal of final_project_txrx_fp_Scale3_I2_atb is
...
component final_project_txrx_fp_Scale3_I2_stm is
    port (
...
dut : final_project_txrx_fp_Scale3_I2 port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
...
sim : final_project_txrx_fp_Scale3_I2_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
