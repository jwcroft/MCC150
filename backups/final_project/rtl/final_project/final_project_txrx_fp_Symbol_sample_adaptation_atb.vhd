...
entity final_project_txrx_fp_Symbol_sample_adaptation_atb is
end;

architecture normal of final_project_txrx_fp_Symbol_sample_adaptation_atb is
...
component final_project_txrx_fp_Symbol_sample_adaptation_stm is
    port (
...
dut : final_project_txrx_fp_Symbol_sample_adaptation port map (
    in_4_v_stm,
    in_5_c_stm,
    in_1_left_power_stm,
    in_2_main_power_stm,
...
sim : final_project_txrx_fp_Symbol_sample_adaptation_stm port map (
    in_4_v_stm,
    in_5_c_stm,
    in_1_left_power_stm,
    in_2_main_power_stm,
