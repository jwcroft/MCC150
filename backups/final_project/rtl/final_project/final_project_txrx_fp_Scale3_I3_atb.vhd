...
entity final_project_txrx_fp_Scale3_I3_atb is
end;

architecture normal of final_project_txrx_fp_Scale3_I3_atb is
...
component final_project_txrx_fp_Scale3_I3_stm is
    port (
...
dut : final_project_txrx_fp_Scale3_I3 port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
...
sim : final_project_txrx_fp_Scale3_I3_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
