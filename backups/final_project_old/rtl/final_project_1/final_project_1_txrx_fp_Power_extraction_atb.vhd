...
entity final_project_1_txrx_fp_Power_extraction_atb is
end;

architecture normal of final_project_1_txrx_fp_Power_extraction_atb is
...
component final_project_1_txrx_fp_Power_extraction_stm is
    port (
...
dut : final_project_1_txrx_fp_Power_extraction port map (
    in_7_v_stm,
    in_8_c_stm,
    in_1_left_I_stm,
    in_2_left_Q_stm,
...
sim : final_project_1_txrx_fp_Power_extraction_stm port map (
    in_7_v_stm,
    in_8_c_stm,
    in_1_left_I_stm,
    in_2_left_Q_stm,
