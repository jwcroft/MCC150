...
-- VHDL created from final_project_1_txrx_fp_ChanView1
...
entity final_project_1_txrx_fp_ChanView1_atb is
end;

architecture normal of final_project_1_txrx_fp_ChanView1_atb is
...
component final_project_1_txrx_fp_ChanView1_stm is
    port (
...
signal c0_o_stm : STD_LOGIC_VECTOR (11 downto 0);
...
signal c0_o_dut : STD_LOGIC_VECTOR (11 downto 0);
...
dut : final_project_1_txrx_fp_ChanView1 port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    c0_o_dut,
...
sim : final_project_1_txrx_fp_ChanView1_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    c0_o_stm,
