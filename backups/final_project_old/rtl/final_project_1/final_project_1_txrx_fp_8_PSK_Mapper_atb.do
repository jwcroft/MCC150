...
if {! [file exists $base_dir/final_project_1_txrx_fp_8_PSK_Mapper]} {
    file delete -force $base_dir/final_project_1_txrx_fp_8_PSK_Mapper
}

project new $base_dir final_project_1_txrx_fp_8_PSK_Mapper
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/final_project_1/final_project_1_txrx_fp_8_PSK_Mapper_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/final_project_1/final_project_1_txrx_fp_8_PSK_Mapper_atb.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_8_PSK_Mapper_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_4_qc} mismatch] == 0 && $mismatch } {
                report_mismatch out_4_qc $cyclenum
            }
            if { [catch {exa mismatch_out_1_symbol_I} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_symbol_I $cyclenum
            }
            if { [catch {exa mismatch_out_2_symbol_Q} mismatch] == 0 && $mismatch } {
                report_mismatch out_2_symbol_Q $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps final_project_1_txrx_fp_8_PSK_Mapper_atb 
    do $base_dir/final_project_1/final_project_1_txrx_fp_8_PSK_Mapper_atb.wav.do
