# This is the top level tcl file for 'final_project_1_txrx_fp'
...
if {!$overwrite_opt && [project_exists final_project_1_txrx_fp]} {
    puts "The final_project_1_txrx_fp quartus project already exists."
    puts "Use 'overwrite option' to force project to be over-written/"
} elseif {![file exists "C:/git_projects/MCC150/final_project/./rtl/final_project_1/final_project_1_txrx_fp.tcl"]}    {
    puts "You must run final_project_1_txrx_fp.tcl "
...
puts "Creating final_project_1_txrx_fp Quartus project..."

if $overwrite_opt {
    project_new -overwrite final_project_1_txrx_fp
} else {
    project_new final_project_1_txrx_fp
}

set_global_assignment -name FAMILY "Cyclone V"
set_global_assignment -name TOP_LEVEL_ENTITY final_project_1_txrx_fp
set_global_assignment -name DEVICE 5CSXFC6D 6F31C6
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE C:/git_projects/MCC150/final_project/./rtl/final_project_1/final_project_1_txrx_fp.sdc
source C:/git_projects/MCC150/final_project/./rtl/final_project_1/final_project_1_txrx_fp.add.tcl
...
set_instance_assignment -name VIRTUAL_PIN ON -to ma_0
set_instance_assignment -name VIRTUAL_PIN ON -to ma_1
set_instance_assignment -name VIRTUAL_PIN ON -to ma_2
set_instance_assignment -name VIRTUAL_PIN ON -to ma_3
set_instance_assignment -name VIRTUAL_PIN ON -to ma_4
set_instance_assignment -name VIRTUAL_PIN ON -to ma_5
...
source "C:/git_projects/MCC150/final_project/./rtl/final_project_1/final_project_1_txrx_fp_fpc.add.tcl"
