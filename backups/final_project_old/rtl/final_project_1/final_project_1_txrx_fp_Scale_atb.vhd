...
entity final_project_1_txrx_fp_Scale_atb is
end;

architecture normal of final_project_1_txrx_fp_Scale_atb is
...
component final_project_1_txrx_fp_Scale_stm is
    port (
...
dut : final_project_1_txrx_fp_Scale port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
...
sim : final_project_1_txrx_fp_Scale_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
