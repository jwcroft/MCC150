...
if {! [file exists $base_dir/final_project_1_txrx_fp_Scale]} {
    file delete -force $base_dir/final_project_1_txrx_fp_Scale
}

project new $base_dir final_project_1_txrx_fp_Scale
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/final_project_1/final_project_1_txrx_fp_Scale_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/final_project_1/final_project_1_txrx_fp_Scale_atb.vhd
vcom -quiet $base_dir/final_project_1/final_project_1_txrx_fp_Scale_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps final_project_1_txrx_fp_Scale_atb 
    do $base_dir/final_project_1/final_project_1_txrx_fp_Scale_atb.wav.do
