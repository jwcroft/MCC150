...
if {! [file exists $base_dir/final_project_txrx_fp_SRlatch1]} {
    file delete -force $base_dir/final_project_txrx_fp_SRlatch1
}

project new $base_dir final_project_txrx_fp_SRlatch1
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/final_project/final_project_txrx_fp_SRlatch1_fpc.do"
} else {
...
vcom -quiet $base_dir/final_project/final_project_txrx_fp_SRlatch1.vhd
vcom -quiet -O0 $base_dir/final_project/final_project_txrx_fp_SRlatch1_atb.vhd
vcom -quiet $base_dir/final_project/final_project_txrx_fp_SRlatch1_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_1_q} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_q $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps final_project_txrx_fp_SRlatch1_atb 
    do $base_dir/final_project/final_project_txrx_fp_SRlatch1_atb.wav.do
